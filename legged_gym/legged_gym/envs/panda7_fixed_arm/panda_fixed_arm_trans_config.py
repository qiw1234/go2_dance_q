...
class panda7_fixed_arm_TransCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        motion_files = "opti_traj/output_panda_fixed_arm_json"
        frame_duration = 1 / 50
        RSI = 1  # 参考状态初始化
        # num_actions = 20
        num_observations = 94
...
class panda7_fixed_arm_TransCfgPPO(LeggedRobotCfgPPO):
    class algorithm(LeggedRobotCfgPPO.algorithm):
        entropy_coef = 0.01

    class runner(LeggedRobotCfgPPO.runner):
        run_name = ''
        experiment_name = ('panda7_fixed_arm_trans')
        resume_path = 'legged_gym/logs/panda7_fixed_arm_beat/Dec03_10-34-00_/model_100.pt'
        dance_task_list = ['panda7_fixed_arm_wave', 'panda7_fixed_arm_trot', 'panda7_fixed_arm_turn_and_jump',
                           'panda7_fixed_arm_swing', 'panda7_fixed_arm_beat']
