...
from legged_gym.motion_loader.motion_loader_panda import motionLoaderPanda
from .legged_robot import LeggedRobot


class LeggedRobotPanda(LeggedRobot):
    def __init__(self, cfg: GO2DanceCfg_beat, sim_params, physics_engine, sim_device, headless):
        super().__init__(cfg, sim_params, physics_engine, sim_device, headless)
        # 重新加载动作数据
        self.motion_loader = motionLoaderPanda(motion_files=self.cfg.env.motion_files, device=self.device,
