...
model_path_test2 = './model/test/wave_0102_2.jit'  #  input 60 pd150 单臂挥舞 挥舞幅度大
...
model_path_test4 = './model/test/swing_0104_1.jit'  # 可以一直左右摇摆
model_path_test1 = './model/test/arm_leg_0110_2.jit' #臂足协同
model_path_test3 = './model/test/trot_123009.jit'  #  input 60 pd 150

model_path_test5 = './model/test/turn_and_jump_0110_2.jit' # 跳跃turn_and_jump_0107_1不行

model_path_test6 = './model/test/wavetwoleg_model_18000.jit'

# model_path_test0 = './model/test/stand_model_8000.jit' # 
model_path_test0 = './model/test/stand_0109_2.jit' # 


# model_path_test1 = './model/test/wave_0102_3.jit' # 由wave model 7000转换得到，与0102_2效果一样
# model_path_test1 = './model/test/swing_0104_2.jit'  # 由swing model 58500转换得到，与0104_1效果一样
...
class BJTUDance:
    ...
    def PutToNet(self):
        ...
        # 测试，手动添加噪声
        # self.actor_state += (2 * torch.rand_like(self.actor_state) - 1) * 0.1
