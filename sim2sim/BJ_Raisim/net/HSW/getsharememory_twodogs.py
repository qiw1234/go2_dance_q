...
def GetFromShareMem(shmaddr,semaphore):
    ...
    try:
        ...
        # print('joint_q_d')
        # for i in range(4):
        #     print(result_ptr.contents.sensor_package.joint_qd[i][0],
        #           result_ptr.contents.sensor_package.joint_qd[i][1],
        #           result_ptr.contents.sensor_package.joint_qd[i][2])
        # print('imu_wxyz')
        # print(result_ptr.contents.sensor_package.imu_wxyz[0],
        #           result_ptr.contents.sensor_package.imu_wxyz[1],
        #           result_ptr.contents.sensor_package.imu_wxyz[2])
        # print('joint_q2')
        # for i in range(4):
