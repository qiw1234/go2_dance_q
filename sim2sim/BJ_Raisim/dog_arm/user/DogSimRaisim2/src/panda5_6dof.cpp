...
//            gv[leg * 3 + joint]);
    ...
    Eigen::VectorXd jointState1(dof_root + dof_leg + dof_arm), jointForce1(dof_root + dof_leg + dof_arm), jointPgain1(dof_root + dof_leg + dof_arm),
        jointDgain1(dof_root + dof_leg + dof_arm);
    ...
    float target_q1[18] = {_sharedMemory().robotToSim.spiCommand.q_des_abad[0],
                           ...
                           _sharedMemory().robotToSim.spiCommand.q_des_arm[5]};//desire input

    float target_qd1[18] = {_sharedMemory().robotToSim.spiCommand.qd_des_abad[0],
    ...
    float target_tau1[18] = {_sharedMemory().robotToSim.spiCommand.tau_abad_ff[0],
    ...
    float kp_gain1[18] = {_sharedMemory().robotToSim.spiCommand.kp_abad[0],
    ...
    float kd_gain1[18] = {_sharedMemory().robotToSim.spiCommand.kd_abad[0],
    ...
    if(1)
    {
        ...
        jointVelocityTarget1.head(dof_root + dof_leg + dof_arm).tail(18)<<target_qd1[0],target_qd1[1],target_qd1[2],
        ...
        jointForce1.head(dof_root + dof_leg + dof_arm).tail(18)<<target_tau1[0],target_tau1[1],target_tau1[2],
        ...
        jointPgain1.head(dof_root + dof_leg + dof_arm).tail(18)<<kp_gain1[0],kp_gain1[1],kp_gain1[2],
        ...
        jointDgain1.head(dof_root + dof_leg + dof_arm).tail(18)<<kd_gain1[0],kd_gain1[1],kd_gain1[2],
...
int main(int argc, char* argv[]) {
    ...
    panda5 = world.addArticulatedSystem(binaryPath.getDirectory() + "\\user\\DogSimRaisim2\\rsc\\panda7_nleg_rm_arm\\panda7_nleg_rm_arm_0102.urdf");
    panda7 = world.addArticulatedSystem(binaryPath.getDirectory() + "\\user\\DogSimRaisim2\\rsc\\panda7_nleg_rm_arm\\panda7_nleg_rm_arm_0102.urdf");
