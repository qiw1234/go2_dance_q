...
/// \return                     0-成功，失败返回:错误码, rm_define.h查询.
///
//RM_BASESHARED_EXPORT int Timer(SOCKHANDLE ArmSocket, int time,bool block);   //命名冲突
...
/// \param choose_axis
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
RM_BASESHARED_EXPORT Pose_rm RotateMove(int dev_mode, float *Joint_Cur,int rotateAxis, float rotateAngle, Pose_rm co_tool, Pose_rm co_work, Pose_rm choose_axis);
...
/// \return                     工具位姿
///
RM_BASESHARED_EXPORT Pose_rm end2tool(Pose_rm eu_end, Pose_rm co_tool, Pose_rm co_work);
...
/// \return                     末端位姿
///
RM_BASESHARED_EXPORT Pose_rm tool2end(Pose_rm eu_tool, Pose_rm co_tool, Pose_rm co_work);
...
/// \return                  旋转矩阵
///
RM_BASESHARED_EXPORT Matrix_rm euler2matrix(eul state);
...
/// \return                旋转矩阵
///
RM_BASESHARED_EXPORT Matrix_rm pos2matrix(Pose_rm state);
...
/// \return                位姿
///
RM_BASESHARED_EXPORT Pose_rm matrix2pos(Matrix_rm Mstate);
...
///
RM_BASESHARED_EXPORT Pose_rm Base_To_WorkFrame(Pose_rm state, Matrix_rm matrix);
...
/// \return                       工作坐标系下的位姿
///
RM_BASESHARED_EXPORT Pose_rm WorkFrame_To_Base(Pose_rm state, Matrix_rm matrix);
