...
public:
    ...
    ///  RM_APISHARED_EXPORT
    ///
    RM_SERVICESHARED_EXPORT int Service_RM_API_Init(RM_Callback pCallback);
    ...
    ///
    RM_SERVICESHARED_EXPORT SOCKHANDLE Service_Arm_Socket_Start(char* arm_ip,int arm_port, int devMode, int recv_timeout);
    ...
    ///
    /// \brief Service_Arm_Sockrt_State         查询机械臂连接状态
    /// \param ArmSocket                Socket句柄
    /// \return                         正常返回：SYS_NORMAL 失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Arm_Sockrt_State(SOCKHANDLE ArmSocket);
    ...
    /// \return 0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_All_Tool_Frame(SOCKHANDLE ArmSocket, FRAME_NAME *names);
    ...
    /// \return 0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_All_Work_Frame(SOCKHANDLE ArmSocket, FRAME_NAME *names);
    ...
    /// \return                     0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Set_Install_Pose(SOCKHANDLE ArmSocket, float x,float y,bool block);
    ...
    /// \return                             0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_Arm_Software_Version(SOCKHANDLE ArmSocket, char* plan_version,char* ctrl_version);
    ...
    /// \return                             0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Set_Force_Postion(SOCKHANDLE ArmSocket, int mode,int force_level,bool block);
    ...
    /// \return 0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Set_Force_Sensor(SOCKHANDLE ArmSocket, bool block);
    ...
    ///
    /// \brief Service_Set_PWM 该函数用于设置末端PWM输出
    /// \param ArmSocket socket句柄
    ...
    /// \return 0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Set_PWM(SOCKHANDLE ArmSocket, int Frq, int Dpulse, bool block);
    ...
    /// \return 0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Auto_Set_Fz(SOCKHANDLE ArmSocket, bool block);
    ...
    /// \return                         0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Set_Lift_Speed(SOCKHANDLE ArmSocket, int speed,bool block);
    ...
    /// \return                             0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Force_Position_Move_POSE(SOCKHANDLE ArmSocket, POSE pose,byte sensor,byte mode,int dir,float force,bool block);
    RM_SERVICESHARED_EXPORT int Service_Force_Position_Move_Joint(SOCKHANDLE ArmSocket, const float *joint,byte sensor,byte mode,int dir,float force,bool block);
    ...
    /// \return
    ///
    RM_SERVICESHARED_EXPORT KINEMATIC Service_Forward_Kinematics(int dev_mode, const float * joint);
    ...
    ///
    RM_SERVICESHARED_EXPORT int Service_Inverse_Kinematics(int dev_mode, const float *q_in, const KINEMATIC *q_pose, float *q_out,const uint8_t flag);
};
