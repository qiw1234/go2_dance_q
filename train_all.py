...
# print("go2_beat")
# os.system("python legged_gym/legged_gym/scripts/train.py --task=go2_beat --num_envs=4096 --headless")
print("go2_turn_and_jump")
os.system("python legged_gym/legged_gym/scripts/train.py --task=go2_turn_and_jump --num_envs=4096 --headless")
print("go2_wave")
os.system("python legged_gym/legged_gym/scripts/train.py --task=go2_wave --num_envs=4096 --headless")
# print("go2_pace")
# os.system("python legged_gym/legged_gym/scripts/train.py --task=go2_pace --num_envs=54096 --headless")
print("go2_trot")
os.system("python legged_gym/legged_gym/scripts/train.py --task=go2_trot --num_envs=4096 --headless")
