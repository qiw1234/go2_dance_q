...
# python legged_gym/legged_gym/scripts/train_panda.py --task=panda7_fixed_gripper_spacetrot --num_envs=8192 --headless
# python legged_gym/legged_gym/scripts/train_panda.py --task=panda7_fixed_gripper_turn_and_jump --num_envs=8192 --headless
# python legged_gym/legged_gym/scripts/train_panda.py --task=panda7_fixed_gripper_wave --num_envs=8192 --headless
# python legged_gym/legged_gym/scripts/train_panda.py --task=panda7_fixed_gripper_trot --num_envs=8192 --headless
# python legged_gym/legged_gym/scripts/train_panda.py --task=panda7_fixed_gripper_swing --num_envs=8192 --headless